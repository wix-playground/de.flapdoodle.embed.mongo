...
Stable (Maven Central Repository, Released: 11.04.2015 - wait 24hrs for [maven central](http://repo1.maven.org/maven2/de/flapdoodle/embed/de.flapdoodle.embed.mongo/maven-metadata.xml))
...
Snapshots (Repository http://oss.sonatype.org/content/repositories/snapshots)
	...
	<dependency>
		<groupId>de.flapdoodle.embed</groupId>
		<artifactId>de.flapdoodle.embed.mongo</artifactId>
		<version>1.47.3-SNAPSHOT</version>
	</dependency>
